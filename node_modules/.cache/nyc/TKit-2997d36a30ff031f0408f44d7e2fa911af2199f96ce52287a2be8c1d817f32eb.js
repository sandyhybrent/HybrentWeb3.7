...
describe('Hybrent Templates Module for Kit', function () {
  ...
  it('Templates Kit page should open', async function () {
    browser.sleep(2000);
    var Kit = await element.all(by.className('nav-link')).get(2);
    Kit.click();
    browser.sleep(2000);
  ...
  it('Add Kit Template', async function () {
    ...
    await element(by.model('tempData.template_name')).sendKeys('Kit' + randNumber);
  ...
  it('Add item to newly created kit template', async function () {
  ...
  it('Search Kit template by name', function () {
    browser.sleep(2000);
    let search = await element(by.css("div.tab-content > div:nth-of-type(3) #PONUM"));
    await search.clear().sendKeys('Kit' + randNumber);
    browser.sleep(2000);
    let search_button = await element.all(by.buttonText('Search')).get(2);
  ...
  it('update newly created Kit template', async function () {
    browser.sleep(2000);
    let edit_scanout = await element.all(by.className("fa fa-edit")).get(2);
    await edit_scanout.click();
    browser.sleep(2000);
    ...
    browser.sleep(2000);
    await element(by.buttonText('Create Kit Item')).click();
    browser.sleep(2000);
    await element(by.css('.sa-confirm-button-container')).element(by.buttonText('Yes')).click();
  ...
  it('make a kit template', async function () {
    browser.wait(EC.elementToBeClickable(element(by.xpath("//a[contains(.,'Make')]"))), 20000);
    await element(by.xpath("//a[contains(.,'Make')]")).click();
    ...
    await element(by.xpath("//hyb-tree-select[1]//span[1]/span[contains(.,'Select inventory location')]")).click();
    browser.wait(EC.elementToBeClickable(element(by.buttonText('Select'))), 20000);
    await element(by.buttonText('Select')).click();
    browser.wait(EC.elementToBeClickable(element(by.buttonText('Make Kit'))), 20000);
    await element(by.buttonText('Make Kit')).click();
    browser.sleep(2000);
    var inventory_popup = await element(by.css('.sa-confirm-button-container'));
    await inventory_popup.isPresent().then(async function (present) {
      if (present) {
        ...
        await element(by.buttonText('Add To Inventory')).click();
      } else {
  ...
  it('delete newly created Kit template', async function () {
    browser.wait(EC.elementToBeClickable(element.all(by.className("fa fa-trash-o"))), 20000);
    let delete_template = await element.all(by.className("fa fa-trash-o")).get(2);
    await delete_template.click();
    browser.wait(EC.elementToBeClickable(element(by.buttonText('Yes'))), 20000);
    await element(by.buttonText('Yes')).click();
